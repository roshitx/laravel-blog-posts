...
@section('container')
	...
	<div class="row justify-content-center mb-3">
		<div class="col-md-6">
			<form action="/post">
				{{-- Jika ada query category --}}
				@if (request('category'))
					<input type="hidden" name="category" value="{{ request('category') }}">
				@endif

				{{-- Jika ada query author --}}
				@if (request('author'))
				...
				<p class="text-body-tertiary">
					<small>
						By <a href="/post?author={{ $posts[0]->author->username }}"
							...
							href="/post?category={{ $posts[0]->category->slug }}"
			...
			<div class="row">
				@foreach ($posts->skip(1) as $post)
					<div class="col-md-4 mb-5">
						<div class="card">
							<div class="position-absolute rounded px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a
